function [Camera] = sm_vehicle_camera_generate_structure(camera_param)
...
Camera.View_SeatFL.a.Value = [0 10 0];    % Point camera forward
Camera.View_SeatFR  = frameData(camera_param.seat_fl.*[1 -1 1]); % Front Right
Camera.View_SeatFR.a.Value = [0 10 0];    % Point camera forward
