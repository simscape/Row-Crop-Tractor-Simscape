% Parameters used in scenes of sm_tractor_row_crop.slx
...
%% Orchard Terrain %%
SceneData.Orchard.gridsurf = sm_tractor_row_crop_sceneorchard;
SceneData.Orchard.color    = [0.5569 0.9608 0.6118];

%% Uneven Road %%
load GS_Uneven_Road_GSD
fNames = fieldnames(gsd);
for i = 1:length(fNames)
    SceneData.Uneven_Road.gsd.(fNames{i}) = gsd.(fNames{i});
end
clear gsd fNamess
