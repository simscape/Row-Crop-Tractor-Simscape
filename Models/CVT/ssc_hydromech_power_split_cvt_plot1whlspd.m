function ssc_hydromech_power_split_cvt_plot1whlspd(simlog_veh, tire_radiusF, tire_radiusR)
...
simlog_vLF = simlog_veh.Vehicle.Tires_and_Body.Tire_FL.A.w.series.values('rad/s')*tire_radiusF*3.6;
simlog_vRF = simlog_veh.Vehicle.Tires_and_Body.Tire_FR.A.w.series.values('rad/s')*tire_radiusF*3.6;
simlog_vLR = simlog_veh.Vehicle.Tires_and_Body.Tire_RL.A.w.series.values('rad/s')*tire_radiusR*3.6;
simlog_vRR = simlog_veh.Vehicle.Tires_and_Body.Tire_RR.A.w.series.values('rad/s')*tire_radiusR*3.6;
