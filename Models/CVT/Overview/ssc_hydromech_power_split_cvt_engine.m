...
ssc_hydromech_power_split_cvt_plot1whlspd(simlog_ssc_hydromech_power_split_cvt_engine.Vehicle_with_CVT,VehicleData.TireDataF.param.DIMENSION.UNLOADED_RADIUS,VehicleData.TireDataR.param.DIMENSION.UNLOADED_RADIUS)
...
ssc_hydromech_power_split_cvt_plot5clutches(simlog_ssc_hydromech_power_split_cvt_engine.Vehicle_with_CVT.Transmission)
...
ssc_hydromech_power_split_cvt_plot3torque(simlog_ssc_hydromech_power_split_cvt_engine.Vehicle_with_CVT)
ssc_hydromech_power_split_cvt_plot2pressure(simlog_ssc_hydromech_power_split_cvt_engine.Vehicle_with_CVT.Transmission)
ssc_hydromech_power_split_cvt_plot5clutches(simlog_ssc_hydromech_power_split_cvt_engine.Vehicle_with_CVT)
...
% of time where the vehicle is not moving. During periods when the vehicle is
