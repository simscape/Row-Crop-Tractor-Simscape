...
ssc_hydromech_power_split_cvt_plot1whlspd(simlog_ssc_hydromech_power_split_cvt,VehicleData.TireDataF.param.DIMENSION.UNLOADED_RADIUS,VehicleData.TireDataR.param.DIMENSION.UNLOADED_RADIUS)
